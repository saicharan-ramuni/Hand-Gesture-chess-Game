        ...
        for c in range(8):
            ...
            if piece and piece.color != color:
                if king_pos in get_valid_moves(piece, r, c):
                    checked_king_pos = king_pos  # Update global var
                    return True

    checked_king_pos = None  # Clear if not in check
    return False
    ...
    for r in range(8):
        for c in range(8):
            ...
            if piece and piece.color == current_player:
                valid_moves = get_legal_moves(piece, r, c)
...
def handle_click(pos):
    ...
    global promotion_pending, promotion_position, promotion_color
